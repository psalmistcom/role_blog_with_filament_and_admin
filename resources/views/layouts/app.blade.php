...
<head>
    ...
    <title>{{ $metaTitle ?: 'QBlog' }}</title>
    <meta name="author" content="HighQ Innovations">
...
<body class="bg-gray-50 font-family-karla">
                ...
                <div>
                    @auth
                        <div class="flex sm:items-center sm:ms-6">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button class="inline-flex hover:bg-blue-600 hover:text-white rounded py-2 px-4 mx-2">
                    ...
                    @else
                        <a href="{{ route('register') }}"
                            class="hover:bg-blue-600 hover:text-white rounded py-2 px-4 mx-2 text-white bg-slate-900 ">Join
                            Us</a>
                    @endauth
                </div>
    ...
    <footer class="w-full border-t bg-white pb-12">
        ...
        <div class="w-full container mx-auto flex flex-col items-center">
            ...
            <div class="uppercase pb-6">&copy; qblog.com</div>
        </div>
    </footer>
